...
func (maker *JWTMaker) CreateToken(id string, role store.Role, duration time.Duration) (string, *JWTClaims, error) {
...
func (maker *JWTMaker) VerifyToken(tokenStr string) (*JWTClaims, error) {
